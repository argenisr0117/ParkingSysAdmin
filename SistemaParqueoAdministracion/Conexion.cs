...
namespace SistemaParqueoAdministracion
{
    class Conexion
    {
        public SqlConnection conexion = new SqlConnection(ConfigurationManager.ConnectionStrings["SistemaParqueoAdministracion.Properties.Settings.Conexion"].ConnectionString);
